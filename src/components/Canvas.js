...
const Canvas = () => {
  ...
  return (
    <div className='w-full h-full pb-[95px] min-h-screen bg-[#121212] flex flex-col justify-center items-center border-[1px] border-blue-400 overflow-y-hidden'>
      <div
      ...
      >
        <div className='flex justify-center items-center h-auto  py-2  gap-3  px-2 sm:col-span-12 md:col-span-6 lg:col-span-3 lg:ml-[250px]  xl:col-span-2 xl:ml-8 2xl:ml-24 2xl:col-span-2 border-blue-500 border-[1px]'>
        ...
        <div className='flex items-center justify-center gap-2  px-2  py-1 sm:col-span-12 md:col-span-6 lg:col-span-3 lg:ml-[120px] xl:col-span-4  2xl:col-span-4 border-blue-500 border-[1px]'>
        ...
        <div className='flex gap-2 items-center justify-center px-2 py-1 xs:overflow-x-auto xs:flex-wrap xs:justify-evenly xs:gap-0 sm:col-span-12 md:col-span-8 md:ml-[250px] lg:col-span-8 xl:col-span-5 xl:ml-24 2xl:w-[auto] 2xl:col-span-5 border-blue-500 border-[1px]'>
      ...
      <div
        id='canvas-container'
        className='flex items-center overflow-y-hidden justify-center overflow-auto w-auto h-full border-blue-400 border-[1px]'
        style={{
        ...
        {!showGallery ? ( //white text
          ...
          <div className='flex flex-col gap-4 w-full h-full item-center justify-center sm:mt-[100px] md:mt-[10px]'>
            {!selectedImage && showGallery && (
              <div className='w-auto justify-center border-blue-400 border-[1px] text-center text-wrap p-4 rounded-lg shadow-md h-auto xs:text-sm xs:w-1/2 xs:mt-32 xs:mx-auto xs:text-wrap sm:w-2/3 sm:mt-32 sm:mx-auto sm:text-wrap'>
      ...
      <div
        className={`w-auto p-2 my-4 flex items-center gap-4 text-center justify-center  overflow-y-hidden border-blue-600 border-[1px]  ${
      ...
      <div className='flex w-full overflow-x-auto gap-2 mt-4 border-blue-400 border-[1px]  sm:w-full'>
        {showGallery &&
